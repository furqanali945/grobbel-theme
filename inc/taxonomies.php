...
// Register Recipe Taxonomy
function custom_guide_categories() {
	...
	$labels = array(
		...
		'separate_items_with_commas' => __( 'Separate Guide Categories with commas', 'text_domain' ),
		'add_or_remove_items'        => __( 'Add or remove Guide Categories', 'text_domain' ),
		'choose_from_most_used'      => __( 'Choose from the most used', 'text_domain' ),
		'popular_items'              => __( 'Popular Guide Categories', 'text_domain' ),
		'search_items'               => __( 'Search Guide Categories', 'text_domain' ),
		'not_found'                  => __( 'Not Found', 'text_domain' ),
		'no_terms'                   => __( 'No Guide Categories', 'text_domain' ),
	...
	register_taxonomy( 'guide_categories', array( 'cooking_guide' ), $args );
}
add_action( 'init', 'custom_guide_categories', 0 );